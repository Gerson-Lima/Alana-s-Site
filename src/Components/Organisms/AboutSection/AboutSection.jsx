    ...
    <section className="about-bg scroll-mt-28" id="about">
      <div className="max-w-7xl mx-auto px-6 xl:px-0 sm:mt-16 md:mt-1">
        ...
        <div className="hidden lg:flex flex-row items-center gap-6">
          ...
          {/* Barra vertical */}
          <div className="w-[3px] bg-[#202020] mr-14 self-stretch my-16"></div>
        ...
        <div className="flex flex-col lg:hidden items-center gap-8 sm:pt-10">
          ...
          {/* Barra vertical */}
          <div className="hidden lg:block w-[3px] bg-[#202020] mr-14 self-stretch my-16"></div>
          ...
          {/* Título */}
          <h2 className="text-2xl font-primary font-semibold text-[#472D2D] leading-normal text-center">
            ARQUITETA,<br />
            URBANISTA &<br />
            DESIGNER DE INTERIORES.
          </h2>

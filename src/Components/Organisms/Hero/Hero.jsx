    ...
    <section className="flex flex-col lg:flex-row items-center justify-center px-4 pt-20 lg:pt-32 sm:pt-32 hero-bg" id="home">
      <div className="mx-auto flex flex-col lg:flex-row items-center justify-between space-y-6 lg:space-y-0 lg:space-x-8 w-full max-w-7xl px-0 sm:px-7 xl:px-0">
        <div className="text-left max-w-xl pb-16">
          <h1 className="lg:text-4xl sm:text-[18px] md:text-[40px] 2sm:text-[34px] font-primary font-extrabold text-gray-800 mb-3 flex flex-col" data-aos="fade-up" data-aos-duration="1000">
          ...
          <a
            href="#contact"
            className="inline-block px-6 py-3 bg-secondary text-white font-semibold font-primary rounded-[2px] hover:bg-[#8E5858] transition" data-aos="zoom-out-up" data-aos-duration="1400"
          >
            Tire suas dúvidas{" "}
            <span
              className="pl-2"
        ...
        <div className="lg:block w-full lg:w-auto" data-aos="fade" data-aos-duration="1400">
          <img
            src={imgHero}
            alt="Imagem hero"
